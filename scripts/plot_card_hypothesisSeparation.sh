python python/plotHypothesisSeparation.py -b  --fileDIR output/DataCards_WW_SS_HypothesisSeparation_noH_Dynamic_PhaseI/Card2D/datacardSeparation/computeHypoSeparation/ --channel  COMB --outputPlotDIR  plotHypoSeparation/ --inputVariable R_mll --nbin 250 --qmin -200 --qmax 200 --coupling 0
