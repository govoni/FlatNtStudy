...
python python/runCombine.py  --computeProfileLikelihood --datacardDIR output/DataCards_WW_SS_HvsNoH/Card2D/ --outputDIR computeProfileLikelihood --batchMode --queque cmscaf1nh --channel EE --nToys 1000  --rMin 0 --rMax 2 --inputVariableList cfg/DataCardCfg/HvsNoHCards/Variables2D.txt --injectSignal 1 --is2Dcard

python python/runCombine.py  --computeProfileLikelihood --datacardDIR output/DataCards_WW_SS_HvsNoH/Card2D/ --outputDIR computeProfileLikelihood --batchMode --queque cmscaf1nh --channel DF --nToys 1000  --rMin 0 --rMax 2 --inputVariableList cfg/DataCardCfg/HvsNoHCards/Variables2D.txt --injectSignal 1 --is2Dcard
...
python python/runCombine.py  --makeLikelihoodScan --datacardDIR output/DataCards_WW_SS_HvsNoH/Card2D/ --outputDIR computeLikelihoodScan --batchMode --queque cmscaf1nh --channel EE --rMin 0 --rMax 2 --inputVariableList cfg/DataCardCfg/HvsNoHCards/Variables2D.txt --injectSignal 1 --is2Dcard --nToys -1 

python python/runCombine.py  --makeLikelihoodScan --datacardDIR output/DataCards_WW_SS_HvsNoH/Card2D/ --outputDIR computeLikelihoodScan --batchMode --queque cmscaf1nh --channel DF --rMin 0  --rMax 2 --inputVariableList cfg/DataCardCfg/HvsNoHCards/Variables2D.txt --injectSignal 1 --is2Dcard --nToys -1 

python python/runCombine.py  --makeLikelihoodScan --datacardDIR output/DataCards_WW_SS_HvsNoH/Card2D/ --outputDIR computeLikelihoodScan --batchMode --queque cmscaf1nh --channel COMB --rMin 0  --rMax 2 --inputVariableList cfg/DataCardCfg/HvsNoHCards/Variables2D.txt --injectSignal 1 --is2Dcard --nToys -1  --noCombineCards
