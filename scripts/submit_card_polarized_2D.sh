python python/runCombine.py  --maximumLikelihoodFit --datacardDIR output/DataCards_WW_SS_Polarized/Card2D/ --outputDIR computeMaximumLikelihoodFit --batchMode --queque cmscaf1nd --channel UU --nToys 100  --rMin -1 --rMax 3 --inputVariableList cfg/DataCardCfg/PolarizedCards/Variables2D.txt --injectSignal 1 --is2Dcard

python python/runCombine.py  --maximumLikelihoodFit --datacardDIR output/DataCards_WW_SS_Polarized/Card2D/ --outputDIR computeMaximumLikelihoodFit --batchMode --queque cmscaf1nd --channel EE --nToys 100  --rMin -1 --rMax 3 --inputVariableList cfg/DataCardCfg/PolarizedCards/Variables2D.txt --injectSignal 1 --is2Dcard

python python/runCombine.py  --maximumLikelihoodFit --datacardDIR output/DataCards_WW_SS_Polarized/Card2D/ --outputDIR computeMaximumLikelihoodFit --batchMode --queque cmscaf1nd --channel DF --nToys 100  --rMin -1 --rMax 3 --inputVariableList cfg/DataCardCfg/PolarizedCards/Variables2D.txt --injectSignal 1 --is2Dcard

python python/runCombine.py  --maximumLikelihoodFit --datacardDIR output/DataCards_WW_SS_Polarized/Card2D/ --outputDIR computeMaximumLikelihoodFit --batchMode --queque cmscaf1nd --channel COMB --nToys 100  --rMin -1 --rMax 3 --inputVariableList cfg/DataCardCfg/PolarizedCards/Variables2D.txt --injectSignal 1 --is2Dcard
...
python python/runCombine.py  --computeAsymptotic --datacardDIR output/DataCards_WW_SS_Polarized/Card2D/ --outputDIR computeAsymptotic --batchMode --queque cmscaf1nd --channel UU --nToys 100  --rMin -1 --rMax 3 --inputVariableList cfg/DataCardCfg/PolarizedCards/Variables2D.txt --injectSignal 1 --is2Dcard

python python/runCombine.py  --computeAsymptotic --datacardDIR output/DataCards_WW_SS_Polarized/Card2D/ --outputDIR computeAsymptotic --batchMode --queque cmscaf1nd --channel EE --nToys 100  --rMin -1 --rMax 3 --inputVariableList cfg/DataCardCfg/PolarizedCards/Variables2D.txt --injectSignal 1 --is2Dcard

python python/runCombine.py  --computeAsymptotic --datacardDIR output/DataCards_WW_SS_Polarized/Card2D/ --outputDIR computeAsymptotic --batchMode --queque cmscaf1nd --channel DF --nToys 100  --rMin -1 --rMax 3 --inputVariableList cfg/DataCardCfg/PolarizedCards/Variables2D.txt --injectSignal 1 --is2Dcard

python python/runCombine.py  --computeAsymptotic --datacardDIR output/DataCards_WW_SS_Polarized/Card2D/ --outputDIR computeAsymptotic --batchMode --queque cmscaf1nd --channel COMB --nToys 100  --rMin -1 --rMax 3 --inputVariableList cfg/DataCardCfg/PolarizedCards/Variables2D.txt --injectSignal 1 --is2Dcard --noCombineCards
