...
python python/runLumiExtrapolation.py --datacardDIR output/DataCards_WW_SS_Inclusive/Card1D/lumiExtrapolation/ --inputVariable ptjj --outputDIR computeProfileLikelihood --makeProfileLikelihood --injectSignal 1 --nToys 500 --rMin 0.85 --rMax 1.15 --batchMode --queque cmscaf1nh --noGenerateCards
